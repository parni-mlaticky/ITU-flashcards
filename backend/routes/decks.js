...
router.delete("/:deckId", wrapped(async (req, res) => {
...
router.get("/:deckId/cards", wrapped(async (req, res) => {
    const cards = await Flashcard.getAllInDeck(req.params.id);
    res.status(200).json(cards);
}));

// Create a card
router.post("/:deckId/cards", wrapped(async (req, res) => {
    const id = null;
...
// Edit a card
router.put("/:deckId/cards/:cardId", wrapped(async (req, res) => {
...
// Delete a card
router.delete("/:deckId/cards/:cardId", wrapped(async (req, res) => {
